...
public class Programming {
    ...
    of "programming languages" the value variable
    should be printed. Example, if we pass "Java",
    ...
    public static void main(String[] args) {
        Programming pm=new Programming("Java");
        Programming pm2=new Programming();
